...
var robbeduser = null;
var enemiesalive = 0;
Crafty.sprite(472,99, "images/bullet.png", {
    Bullet: [0,0]
});
        
        	Crafty.sprite(472,99, "images/gunfire.png", {
    Gunfire: [150,150]
});
        Crafty.sprite(350,350, "images/enemy.png", {
    EnemySprite: [0,0]
});
		Crafty.sprite(650,650, "images/gangster.png", {
    PlayerSprite: [0,0]
});
		Crafty.sprite(891, 150,"images/tram.png", {
		tram: [0,0]
		});
        Crafty.sprite(986, 487,"images/truck.png", {
		Truck: [0,0]
		});
        
        Crafty.sprite(888,244,"images/building.png", {
    Building1: [0,0]
    });
Crafty.sprite(116,347,"images/Ammo.png", {
    Ammo: [0,0]
    });
Crafty.audio.add("backgroundMusic", [
"sounds/titletrack.mp3",
]);
var player;
var playerhealth = 5;
var Ammo = 5;
var healthbar;
		...
		Crafty.background('#FFFFFF url(images/startbg.png) repeat');
   ...
   .append(usertable)
		...
		Crafty.init(1000, 600, document.getElementById('game'));
		Crafty.background('#FFFFFF url(images/bg.png) repeat');
...
"sounds/shot.wav"
                ...
                Crafty.defineScene("Scene2", function() {
							Crafty.background('#FFFFFF url(images/indoorbg.png) repeat');
							Crafty.e("2D, DOM, Color, solid, left")
...
Crafty.defineScene("SceneLost", function() {
							Crafty.background('#FFFFFF url(images/lost.jpg) repeat ');
							Crafty.e("2D, DOM, Color, solid, left");
...
Crafty.defineScene("SceneWon", function() {
	player.destroy();
							Crafty.background('#FFFFFF url(images/won.jpg) repeat ');
							Crafty.e("2D, DOM, Color, solid, left");
