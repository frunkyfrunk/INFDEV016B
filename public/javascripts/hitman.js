Crafty.defineScene("hitman", function () {
	...
	jQuery(document).ready(function ($) {
		...
		Crafty.scene("main", function () {
			...
			//Wrong Guy
			Crafty.sprite(81, 299, './images/man4.png', {
				s1: [0, 0]
			});
			...
			//Right Guy
			Crafty.sprite(81, 299, './images/man6.png', {
				s2: [0, 0]
			});
			...
			//Wrong Guy
			Crafty.sprite(81, 299, './images/woman1.png', {
				s3: [0, 0]
			});
	...
	function Lvl2() {
		...
		jQuery(document).ready(function ($) {
			...
			Crafty.scene("main", function () {
				...
				//Right Guy
				Crafty.sprite(95, 252, './images/woman4.png', {
					s1: [0, 0]
				});
				var suspect1 = Crafty.e('2D, Canvas, s1, Mouse')
					.attr({
				...
				//Wrong Guy
				Crafty.sprite(95, 252, './images/woman3.png', {
					s2: [0, 0]
				});
				var suspect2 = Crafty.e('2D, Canvas, s2, Mouse')
					.attr({
				...
				//Wrong Guy
				Crafty.sprite(81, 299, './images/man3.png', {
					s3: [0, 0]
				});
				var suspect3 = Crafty.e('2D, Canvas, s3, Mouse')
					.attr({
